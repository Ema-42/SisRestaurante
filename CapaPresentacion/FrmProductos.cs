...
namespace CapaPresentacion
{
    public partial class FrmProductos : Form
    {
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.cbCategorias.Enabled = valor;
        ...
        {
            cbCategorias.DataSource = NCategoria.Mostrar();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.txtNombre.Text == string.Empty || this.txtDescripcion.Text == string.Empty)
                {
                    ...
                    errorIcono.SetError(cbCategorias, "Ingrese una Categoria");
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        ...
                        rpta = NProductos.Insertar(this.txtNombre.Text.Trim().ToUpper(), this.txtDescripcion.Text.Trim(), Convert.ToDecimal(this.txtPrecio.Text), Convert.ToInt32(this.cbCategorias.SelectedValue));
                    }
                    else
                    {
                        //este es el caso de editar un registro
                        rpta = NProductos.Editar(Convert.ToInt32(this.txtIdproducto.Text),
                            this.txtNombre.Text.Trim().ToUpper(), this.txtDescripcion.Text.Trim(), Convert.ToDecimal(this.txtPrecio.Text), Convert.ToInt32(this.cbCategorias.SelectedValue));
                    }
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.cbCategorias.SelectedValue = Convert.ToString(this.dataListado.CurrentRow.Cells["idcategoria"].Value);
